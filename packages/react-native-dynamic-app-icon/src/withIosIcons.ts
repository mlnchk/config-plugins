// https://github.com/expo/expo/blob/e81992bbef3e626d7d67f3c3238f774ac2570abf/packages/%40expo/prebuild-config/src/plugins/icons/withIosIcons.ts
...
function getAppleIconName(size: number, scale: number): string {
  return `App-Icon-${counter}-${size}x${size}@${scale}x.png`;
}
